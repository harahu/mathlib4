...
/-!
# Subfunctors that are generated by finitely many sections
...
that `G` is the subfunctor generated by the sections `x i`. If this holds for
...
/-- A subfunctor `G : Subfunctor F` is generated by sections `x i : F.obj (X i)`
...
/-- A subfunctor of types is "finite" if it is generated by finitely many sections. -/
...
/-- A choice of index type for the generating sections of a finitely generated subfunctor. -/
...
/-- Objects on which a choice of generating sections of a finitely generated subfunctor
are defined. -/
noncomputable def X : Index G → Cᵒᵖ :=
  hG.exists_isGeneratedBy.choose_spec.choose_spec.choose

/-- A choice of generating sections of a finitely generated subfunctor. -/
